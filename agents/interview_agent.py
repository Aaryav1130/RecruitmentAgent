...
class InterviewAgent:
    ...
    def generate_interview_questions(self, job_data, resume_data=None, question_count=5):
        """
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    # IF that  fais,try to extract JSON array pattern
                    json_pattern=r'\[\s*\{.*\}\s*\]'
                    ...
                    if json_match:
                        ...
                        for block in question_blocks:
                            ...
                            # Try to extract parts from the blocks
                ...
                return [{"question": str(response.content).strip()}]
    ...
    def _generate_basic_questions(self,job_data,question_count=5):
